#ifndef _INTERPOLATOR2_HPP_
#define _INTERPOLATOR2_HPP_
#include <string>
#include <exception>
#include <memory>
...
class Interpolator2 {
 public:
   ...
   * Copy constructor
   */
  Interpolator2(const Interpolator2&);
  /**
   * Constructor
 ...
 private:
   ...
   */
  std::vector<std::shared_ptr<BaseRangeInterpolator2>> _rangeInterpolator2s;
};
