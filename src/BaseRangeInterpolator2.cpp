 ...
 * @param extCMEnergies extended vector of center-of-mass energies (contains
 threshold energy)
*/
BaseRangeInterpolator2::BaseRangeInterpolator2(
 ...
 * Copy constructor
 */
BaseRangeInterpolator2::BaseRangeInterpolator2(const BaseRangeInterpolator2& rinterp):
 ...
 */
bool BaseRangeInterpolator2::hasCSIndex(int csIndex) const {
 ...
 */
bool BaseRangeInterpolator2::isEnergyInRange(double energy) const {
...
*/
int BaseRangeInterpolator2::getBeginIndex() const {
  return _beginIndex;
}
...
*/
int BaseRangeInterpolator2::getNumberOfSegments() const {
 ...
 */
int BaseRangeInterpolator2::_evalNumOfSegments(
    int rangeIndexMin,
    int rangeIndexMax) {
 ...
 * @param rangeIndexMax a maximum sub range index
 */
int BaseRangeInterpolator2::_evalBeginIndex(int rangeIndexMin,
                                           int rangeIndexMax) {
 ...
 * @param energy a center-of-mass energy
 */
double BaseRangeInterpolator2::eval(const Eigen::VectorXd& y, double energy) const {
  double result = 0;
 ...
 * @param energy a center-of-mass energy
 */
double BaseRangeInterpolator2::derivEval(const Eigen::VectorXd& y, double energy) const {
  double result = 0;
  for (int i = 0; i < _numberOfSegments; ++i) {
    const int index = _beginIndex + i;
    /**
 ...
 */
double BaseRangeInterpolator2::getMinEnergy() const {
  return _minEnergy;
}
 ...
 */
double BaseRangeInterpolator2::getMaxEnergy() const {
  return _maxEnergy;
}
